        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CompanyAdressId = table.Column<int>(nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Companies_CompanyAdress_CompanyAdressId",
                        column: x => x.CompanyAdressId,
                        principalTable: "CompanyAdress",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Companies_CompanySize_SizeId",
                        column: x => x.SizeId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CompanyTechStack", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CompanyTechStack_Companies_CompanyId",
                        column: x => x.CompanyId,
                        principalTable: "Companies",
                        principalColumn: "CompanyId",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SkillsAndRequirements = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Companies_CompanyAdressId",
                table: "Companies",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CompanyTechStack_CompanyId",
                table: "CompanyTechStack",
                column: "CompanyId");
